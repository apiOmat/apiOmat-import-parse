...
def showHelp(sys):
   print 'Usage: import-parse-to-apiOmat -i <inputfile> --appName <appName> --apiKey <apiKey> --system <usedSystem> --userName <userName> --password <userPassword>'
   print 'Example: import-parse-to-apiOmat  -i 9339.zip -a ParseImport -k 0000000 -s LIVE -u login@apiomat.org -p 12345'
   sys.exit()
...
def deployApp():
#    href = baseURL + "/customers/%s/apps/%s" % (userName,appName)
#    postData = {
...
def _setHeader():
   authCreds ="Basic " + base64.b64encode(userName + ":" + password);
   headers = { 
